...
/* Nav */
$l['wiki_nav_category_add'] = "Add category";
$l['wiki_nav_new'] = "New entries";
$l['wiki_nav_category_edit'] = "Edit category";
$l['wiki_nav_category_delete'] = "Delete category";
$l['wiki_nav_add'] = "Add entry";
$l['wiki_nav_edit'] = "Edit entry";
$l['wiki_nav_delete'] = "Delete entry";


/* Lang */
$l['wiki_category_add'] = "Add Wiki category";
$l['wiki_category_edit'] = "Edit Wiki category";
$l['wiki_category_delete'] = "Delete Wiki category";
$l['wiki_add'] = "Add Wiki entry";
$l['wiki_edit'] = "Edit Wiki entry";
$l['wiki_delete'] = "Delete Wiki entry";


/* Errors */
$l['wiki_no_name'] = "Please enter a name for the category!";
$l['wiki_no_cat'] = "Please enter a category!";
...
/* Who is online? */
$l['wiki_wol'] = "Viewing the <a href=\"{1}\">Wiki</a>";
$l['wiki_wol_cat'] = "Views the Wiki category <a href=\"{1}\">{2}</a>";
$l['wiki_wol_cat_add'] = "Adds a new Wiki category";
$l['wiki_wol_cat_edit'] = "Edits the Wiki category <a href=\"{1}\">{2}</a>";
$l['wiki_wol_cat_delete'] = "Deletes the Wiki category <a href=\"{1}\">{2}</a>";
$l['wiki_wol_entry'] = "Reads the Wiki article <a href=\"{1}\">{2}</a>";
$l['wiki_wol_add'] = "Adds a new Wiki article";
$l['wiki_wol_add'] = "Edits the Wiki article <a href=\"{1}\">{2}</a>";
$l['wiki_wol_add'] = "Deletes the Wiki article <a href=\"{1}\">{2}</a>";
$l['wiki_wol_search'] = "Is <a href=\"wiki.php?action=search\">searching</a> in our <a href=\"{1}\">Wiki</a>";
...
/* Moderierung */
$l['wiki_unlock'] = "Unlock";


/* Neue */
$l['wiki_new_article'] = "New entries";
...
$l['wiki_sort_title'] = "Title";
$l['wiki_sort_date'] = "Date";


/*Sonstiges */
$l['wiki_category'] = "Category";
$l['wiki_number'] = "Number";
$l['wiki_name'] = "Name";
$l['wiki_title'] = "Title";
$l['wiki_link'] = "Link";
$l['wiki_short'] = "Short Description";
$l['wiki_text'] = "Text";
$l['wiki_options'] = "Options";
$l['wiki_hide'] = "Hide Entry?";
$l['wiki_close'] = "Close Entry?";
$l['wiki_edit'] = "Edit";
$l['wiki_delete'] = "Delete";
$l['wiki_restore'] = "Restore";
$l['wiki_date'] = "Date";
$l['wiki_user'] = "User";
